...
.\yt-dlp.exe $YouTube_video_URL --ffmpeg-location bin/ --write-subs --sub-langs all --convert-subs srt --skip-download
...
# .\yt-dlp.exe $YouTube_video_URL --ffmpeg-location bin/ --write-subs --sub-langs all --convert-subs ass --skip-download


# Thirdly, download the original subtitle files that are available in youtube
.\yt-dlp.exe $YouTube_video_URL --ffmpeg-location bin/ --write-subs --sub-langs all --skip-download
...
.\yt-dlp.exe $YouTube_video_URL -N 8 --windows-filenames --write-description --write-thumbnail --convert-thumbnails jpg --embed-thumbnail --embed-metadata --embed-chapters --xattrs --ffmpeg-location bin/
